...
public class SkinParserXmlImageDrawable implements BaseSkinParserXml {
    @Override
    public void parserXml(@NonNull View view, @NonNull AttributeModel skinAttr, @NonNull BaseSkinResource resource) {
        ...
        } else if (SkinSetting.RES_TYPE_NAME_MIPMAP.equals(skinAttr.attrValueTypeName)) {
            drawable = resource.getDrawableForMapmip(applicationContext, skinAttr.attrValueRefId);
        }
        if (drawable != null) {
